...
namespace jyxcsjl2
{
    public partial class operationl_tuoliu_cems : UserControl
    {
        public operationl_tuoliu_cems()
        {
            InitializeComponent();
        }
        string begin_time, end_time;

        private void operationl_tuoliu_cems_Load(object sender, EventArgs e)
        {
        ...
        public void sclect_p(DateTime Begin_time, DateTime End_time)
        {
            ...
            {
                var bb = yh.T_PRODUCE_TUOLIU_CEMS.Where(u => u.RECORD_DATE > Begin_time && u.RECORD_DATE <= End_time);
        ...
        public void sclect_t(DateTime Begin_time, DateTime End_time)
        {
            ...
            using (jyxcsjl2.MODEL.T_PROM yh = new jyxcsjl2.MODEL.T_PROM())
            {
                ...
                var bb = yh.T_PRODUCE_TUOLIU_NYJZ.Where(t => (t.RECORD_DATE > Begin_time && t.RECORD_DATE <= End_time));
