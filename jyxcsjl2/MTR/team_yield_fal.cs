...
namespace jyxcsjl2
{
    public partial class team_yield_fal : UserControl
    {
        public team_yield_fal()
        {
            InitializeComponent();
        }
        ...
        public void sclect(DateTime Begin_time, DateTime End_time)
        {
            ...
            {
                var bb = yh.T_MATERIAL_TEAM_YIELD_FAL.Where(u => u.TEAM_END_TIME > Begin_time && u.TEAM_END_TIME <= End_time);
        ...
        private void team_yield_fal_Load(object sender, EventArgs e)
        {
